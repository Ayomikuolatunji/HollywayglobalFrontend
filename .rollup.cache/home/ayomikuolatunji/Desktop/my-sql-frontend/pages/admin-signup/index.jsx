...
var AdminSignup = function () {
    ...
    var adminSignup = useAdminSignupMutation()[0];
    ...
    var onSubmit = function (data) { return __awaiter(void 0, void 0, void 0, function () {
        var email, name_1, password, confirmPassword, error_1, err;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    email = data.email, name_1 = data.name, password = data.password, confirmPassword = data.confirmPassword;
        ...
        <div className="personal-information w-[50%] p-3">
          ...
          <div className="form w-[100%]">
            <div className="first-name flex mt-5 items-center">
              ...
              <div className="ml-12">
                <UI.InputField type="text" className="name  bg-white border-[1px] border-[#dd] outline-none p-1 w-[100%]" isHookForm={true} label="name" register={register} required={true}/>
